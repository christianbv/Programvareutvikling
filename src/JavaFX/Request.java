...
public class Request {
	...
	public Request (String id, String fn, String sn, String rat, String cat, String itemId, String prod) {
	...
	*/
	public Request(String id, String name,String rat,String cat, String produkt, String date,String status,Integer phone  ) {
	...
	public Request(String id,String fn, String sn, String produkt, String date, String status,String foo,String userId) {
		this.IdCol = new SimpleStringProperty(id);
		this.FirstNameCol = new SimpleStringProperty(fn);
		this.SurNameCol = new SimpleStringProperty(sn);
